package com.demiglace.tacodoge.tacos.web;
...
import com.demiglace.tacodoge.tacos.Ingredient;
import com.demiglace.tacodoge.tacos.Ingredient.Type;
import com.demiglace.tacodoge.tacos.Taco;
import com.demiglace.tacodoge.tacos.TacoOrder;
...
@SessionAttributes("tacoOrder") // TacoOrder object should be maintained in session
public class DesignTacoController {
	...
	public void addIngredientsToModel(Model model) {
		...
		// and add the list of ingredients as an attribute to the model that will be
		// passed to showDesignForm()
